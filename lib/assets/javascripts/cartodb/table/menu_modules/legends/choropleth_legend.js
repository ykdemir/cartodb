...
cdb.admin.mod.ChoroplethLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _setupTemplates: function() {
    ...
    this.item_templates = [];
    this.item_templates["text"]  = 'table/menu_modules/legends/views/choropleth_legend_item_text';
    this.item_templates["color"] = 'table/menu_modules/legends/views/choropleth_legend_item_color';
