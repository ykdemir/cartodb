...
cdb.admin.mod.BubbleLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    items.push(new cdb.geo.ui.LegendItemModel({ type: "text",  value: "< " + min }));
    items.push(new cdb.geo.ui.LegendItemModel({ type: "text",  value: max + " >" }));
    items.push(new cdb.geo.ui.LegendItemModel({ type: "color", value: color }));
