...
describe('cdb.admin.mod.LegendEditor ', function() {
  ...
  var panes, view, dataLayer, legendModel, table, wizardProperties;
  ...
  beforeEach(function() {
    ...
    dataLayer.set("wizard_properties", { type: "null" });
  ...
  it('should select a different pane when the wizard changes', function() {
    ...
    dataLayer.set("wizard_properties", { type: "custom" })
  ...
  it('should change the combo when the wizard changes', function() {
    ...
    dataLayer.set("wizard_properties", { type: "category" })
    var templateOptions = view.templates.data;
  ...
  it('should change the type of legend when the wizard changes', function() {
    ...
    expect(view.currentLegend._FILTER_NAME).toEqual("category");

    dataLayer.set("wizard_properties", { type: "none" })
    expect(legendModel.get("type")).toEqual("none");

    expect(view.currentLegend._FILTER_NAME).toEqual("none");
  ...
  it('should change the type of legend when the wizard changes', function() {
    ...
    dataLayer.set("wizard_properties", { type: "oh, what's that?" })
    expect(legendModel.get("type")).toEqual("none");
