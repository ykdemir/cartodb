...
/*
  ...
  describe("cartoparser", function() {
    ...
    /* Checks that 'list' (array) contains 'value' (array) */
    function contains(list, value) {
      return _.find(list, function(v) { return _.isEqual(v, value); }) ? true : false;
    }
    ...
    it("should report errors", function() {
      ...
      parser.parse(style + "aksdjj lakjsdk jaksdjaks");
    ...
    it("should get the colors used", function() {
      var vars = parser.colorsUsed();

      expect(vars.length).toEqual(5);
      expect(contains(vars, [0,0,0])).toEqual(true, [0,0,0]);

      expect(contains(vars, [255,0,0])).toEqual(true, [255,0,0]);
      expect(contains(vars, [0,0,255])).toEqual(true, [0,0,255]);
      expect(contains(vars, [255,102,17])).toEqual(true, [255, 102, 17]);
      expect(contains(vars, [255,255,255])).toEqual(true, [255,255,255]);

    });

    it("should get the colors used in hex", function() {
      var vars = parser.colorsUsed( { mode: "hex" });

      expect(contains(vars, "#ffffff")).toEqual(true, "#FFFFFF should be in the list");
      expect(contains(vars, "#ff6611")).toEqual(true, "#FF6611 should be in the list");
      expect(contains(vars, "#ff0000")).toEqual(true, "#FF0000 should be in the list");
      expect(contains(vars, "#0000ff")).toEqual(true, "#0000FF should be in the list");
